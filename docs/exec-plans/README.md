...
| 文件 | 主题 | 状态 |
|------|------|------|
| [active/v0.67.1-production-feedback-signing-auto-update-2026-08-23.md](active/v0.67.1-production-feedback-signing-auto-update-2026-08-23.md) | **v0.67.1 生产反馈闭环 × macOS 签名与自动更新（Windows/Linux 预留）**：GLM legacy identity、Sentry/SQLite/ABI、macOS 身份门禁、原子 update assets 与 Main-owned updater | 🚢 `v0.67.5` 已 Shipped：正式 CI 的 Developer ID/Team ID、公证/staple/Gatekeeper、双架构+universal、Intel ABI、11 资产图/checksum/attestation 与 draft→公开全绿。用户接受跳过 clean-machine 与 RC-A→RC-B 真实升级 smoke；Sentry production、受影响用户 GLM 仍待 human gate；不冒充 Smoke passed/Release ready |
