...
| 文件 | 主题 | 状态 |
|------|------|------|
| [active/v0.67.1-production-feedback-signing-auto-update-2026-08-23.md](active/v0.67.1-production-feedback-signing-auto-update-2026-08-23.md) | **v0.67.1 生产反馈闭环 × 全平台签名与自动更新**：GLM legacy identity、Sentry/SQLite/ABI、全平台签名门禁、原子 update assets 与 Main-owned updater | 🟡 三轮 review 的 P1/P2 与后续 13 项 P3 已本地修复；P3 定向 72/72、全量 5297/0/1、Build/Electron、mac ABI 与真实 builder ZIP-only metadata 形状通过。Sentry production、受影响用户 GLM、正式 Apple/Windows CI 与 RC-A → RC-B 真实升级待 human gate；未发布 |
