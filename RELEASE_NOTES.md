...
> macOS v0.67.5 及更高正式版可在应用内检查并升级。Windows v0.67.7 及更早版本没有官方更新器标记，必须先手动安装 v0.67.10；Linux 继续手动下载安装。

### macOS

- [Apple Silicon (M1/M2/M3/M4)](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-arm64.dmg)
- [Intel](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-x64.dmg)

### Windows

- [Windows x64 安装包](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot.Setup.0.67.10.exe)
- Windows 安装包未配置 Authenticode 证书，可能显示 SmartScreen。仅从本 Release 下载并核对 SHA-256；应用内也会在安装更新前再次明确提示未签名状态。

### Linux

- [x64 AppImage](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-x86_64.AppImage)
- [arm64 AppImage](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-arm64.AppImage)
- [amd64 DEB](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-amd64.deb)
- [arm64 DEB](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-arm64.deb)
- [x86_64 RPM](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-x86_64.rpm)
- [aarch64 RPM](https://github.com/op7418/CodePilot/releases/download/v0.67.10/CodePilot-0.67.10-aarch64.rpm)

### 完整性验证

- [SHA-256 Checksums](https://github.com/op7418/CodePilot/releases/download/v0.67.10/SHA256SUMS.txt)
...
**Windows**：v0.67.10 是首个支持 Windows 自动更新的正式版，需要手动下载安装。安装后，后续版本会通过 `latest.yml` 优先差分下载未签名 NSIS，失败时回退完整安装包。出现 SmartScreen 时请核对下载来源与 SHA-256；安装前仍会明确提示没有独立发布者签名。
